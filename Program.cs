...
namespace מוחקונטר
{
    class Program
    {
        ...
        static void Main(string[] args) //פעולה ראשית, הקוד מתחיל כאן
        {
            ...
            Console.WriteLine();
            /*args = new string[1];
              args[0] = @"Z:\";     (השורות האלה מגדירות אוטומטית את התיקיה למיקום הרצוי, אם אתה לא מגדיר כתובת בקוד מראש, אז יש להכניס משתנים דרך שורת הפקודה של ווינדוס (או לגרור את התיקייה לתוכנה*/
            if (args.Length == 0)
            {
